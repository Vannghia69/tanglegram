...
def bottom_up(li_MID, link1, link2, min_entang, labels1, labels2):          #works well with 2-3 combination
    ...
    for li_MID in range(len(linkage_matrix1) - 1, 1, -1):
        ...
        for i in all_linkage1:
            for j in all_linkage2:
                ...
                for k in range(10):
                    # This part makes big branches that are similar in 2 dendrogram to be aligned (COARSE ADJUSTMENT)
